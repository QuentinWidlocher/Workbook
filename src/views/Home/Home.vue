<template>
    <div id="home" :class="{ home: !searchOpened, search: searchOpened }">
        <div id="search" v-if="searchOpened">
        ...
        <div id="home-categories" v-if="currentEntry">
            <ItemsSelector
                :items="categories"
                :selectedItems.sync="currentEntry.categories"
                :deletion="true"
                :creation="true"
            />
        </div>
        <div id="home-editor" v-if="!searchOpened">
            <Edition />
